...
t1 = time()
user_items = np.load('../data/user_items.npy',allow_pickle=True).tolist()
traindata = np.load('../data/traindata.npy',allow_pickle=True).tolist()
valdata = np.load('../data/valdata.npy',allow_pickle=True).tolist()
testdata = np.load('../data/testdata.npy',allow_pickle=True).tolist()
A_indexs = np.load('../data/A_indexs.npy',allow_pickle=True).tolist()
A_values = np.load('../data/A_values.npy',allow_pickle=True).tolist()
user_negatives_1000 = np.load('../data/user_negatives_1000.npy',allow_pickle=True).tolist()
item_attributes = np.load('../data/item_attributes.npy',allow_pickle=True).astype(np.float32)
item_attributes_missing = np.load('../data/item_attributes_missing.npy',allow_pickle=True)
existing_item_list = np.load('../data/existing_item_list.npy',allow_pickle=True).tolist()
